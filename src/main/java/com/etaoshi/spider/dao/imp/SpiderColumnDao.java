...
public class SpiderColumnDao implements ISpiderColumnDao {
	 ...
	 * @throws SQLException
	 */
	public int GetCountDataModelByOption(String sql) throws SQLException {
		String stmtId = "SpiderColumn-GetCountDataModelByOption";
		int result = (Integer)mapper.queryForObject(stmtId,sql);
		return result;
	}
